...
## Введение 
---
Данный гайд посвящен практике по Antlr. Вначале мы установим необходимые инструменты для написания мини компилятора и разберемся как написать свой первый компилятор. 
